...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
  ...
  body::before {
    ...
    position: fixed;
    inset: 0;
    background: url('https://upload.wikimedia.org/wikipedia/commons/2/2c/NGC_4414_hubble.jpg') no-repeat center center;
...
<header>
  <img class="roblox-logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Roblox_Logo_2022.png/320px-Roblox_Logo_2022.png" alt="Roblox Logo">
  <h1>CORE'S HUB</h1>
  <button class="scroll-btn" onclick="document.getElementById('scripts').scrollIntoView({behavior:'smooth'})">
    View Scripts
  </button>
</header>
